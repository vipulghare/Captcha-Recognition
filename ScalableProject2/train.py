...
def main():
    ...
    parser.add_argument('--train-dict', help='name for the training dictionary file', type=str)
    parser.add_argument('--validate-dict', help='name for the validate dictionary file', type=str)
    ...
    # with tf.device('/device:XLA_CPU:0'):
        ...
        training_data = ImageSequence(args.train_dataset, training_dictionary, args.batch_size, args.length, captcha_symbols, args.width, args.height)
        validation_data = ImageSequence(args.validate_dataset, validate_dictionary, args.batch_size, args.length, captcha_symbols, args.width, args.height)
